...
<head>
	<meta charset="utf-8">
	<meta name="description" content="Chicago Web Design.">
...
<body>
    ...
    <section id="contact" class="contact">
        <div class="wrapper">
            ...
            <p>Got an idea? Want to improve on something? We’d love to be a part of it. Fill out the form and let’s meet up.</p>
            
            <form class="contact-form">
                <div class="form-left">
                    <div class="form-item select-item">
                        <label for="">I need help with</label>
                        <div class="select-wrap">
                            <select>
                                <option>A website</option>
                                <option>Web Application</option>
                            </select>
                            <div class="out">xxx</div>
                        </div>
                    </div>
                    <div class="form-item">
                        <label for="">Name</label>
                        <input type="text" name="name" placeholder="Bob Plant" />
                    </div>
                    <div class="form-item">
                        <label for="">Email</label>
                        <input type="email" name="email" placeholder="BobRocks@Zep.net" />
                    </div>
                    <div class="form-item">
                        <label for="">Phone</label>
                        <input type="text" name="phone" placeholder="(665) 666-6666" />
                    </div>
                    <div class="form-item select-item">
